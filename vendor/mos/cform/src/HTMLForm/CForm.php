...
class CForm implements \ArrayAccess
{
    ...
    {
        if (isset($_SESSION['form-output' . (isset($this->form["id"]) ? $this->form["id"] : "")])) {
            $_SESSION['form-output' . (isset($this->form["id"]) ? $this->form["id"] : "")] .= " $str";
        } else {
            $_SESSION['form-output' . (isset($this->form["id"]) ? $this->form["id"] : "")] = $str;
        }
        return $this;
...
EOD;
    ...
    public function check($callIfSuccess = null, $callIfFail = null)
    {
        ...
        if (isset($_SESSION['form-output' . (isset($this->form["id"]) ? $this->form["id"] : "")])) {
            $this->output = $_SESSION['form-output' . (isset($this->form["id"]) ? $this->form["id"] : "")];
            unset($_SESSION['form-output' . (isset($this->form["id"]) ? $this->form["id"] : "")]);
        }
